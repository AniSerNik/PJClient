 ...
 * @details Функция устанавливает режимы GPIO кнопки и транзистора дисплея
 */
void lcd_init();

/**
 * @brief Проверка кнопки включения дисплея
 * @details Функция включает дисплей включает его, если кнопка нажата
 */
